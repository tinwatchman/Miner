package net.jonstout.miner.view.theme
{
	...
	public class MinimalMobileTheme extends Theme
	{
		...
		protected static const HEADER_TEXT_COLOR:uint = 0x000000;
		...
		protected var headerFontSize:int;
		protected var titleFontSize:int;
		...
		protected var centeredPrimaryTextFormat:BitmapFontTextFormat;
		protected var rightAlignPrimaryTextFormat:BitmapFontTextFormat;
		protected var titleTextFormat:BitmapFontTextFormat;
		protected var headerTextFormat:BitmapFontTextFormat;
		protected var rightAlignHeaderTextFormat:BitmapFontTextFormat;
		...
		override protected function initialize():void {
			...
			this.headerFontSize = Math.max(4, roundToNearest(48 * this.scale, 8));
			this.titleFontSize = Math.max(4, roundToNearest(64 * this.scale, 8));
			...
			this.centeredPrimaryTextFormat = new BitmapFontTextFormat(bitmapFont, this.fontSize, PRIMARY_TEXT_COLOR, TextFormatAlign.CENTER);
			this.rightAlignPrimaryTextFormat = new BitmapFontTextFormat(bitmapFont, this.fontSize, PRIMARY_TEXT_COLOR, TextFormatAlign.RIGHT);
			this.headerTextFormat = new BitmapFontTextFormat(bitmapFont, this.headerFontSize, HEADER_TEXT_COLOR);
			this.rightAlignHeaderTextFormat = new BitmapFontTextFormat(bitmapFont, this.headerFontSize, HEADER_TEXT_COLOR, TextFormatAlign.RIGHT);
			this.titleTextFormat = new BitmapFontTextFormat(bitmapFont, this.titleFontSize, HEADER_TEXT_COLOR, TextFormatAlign.CENTER);
			...
			// THEME ADDITIONS
			this.setInitializerForClass(Message, messageInitializer);
			this.setInitializerForClass(Alert, alertInitializer);
			this.setInitializerForClass(Confirm, confirmInitializer);
		}
		...
		{
			if (label.name.indexOf("gameTitle") > -1) {
				label.textRendererProperties.textFormat = this.titleTextFormat;
				label.textRendererProperties.wordWrap = true;
			} else if (label.name.indexOf("header") > -1 && label.name.indexOf("rightAlign") > -1) {
				label.textRendererProperties.textFormat = this.rightAlignHeaderTextFormat;
			} else if (label.name.indexOf("header") > -1) {
				label.textRendererProperties.textFormat = this.headerTextFormat;
			} else if (label.name.indexOf("rightAlign") > -1) {
				label.textRendererProperties.textFormat = this.rightAlignPrimaryTextFormat;
			} else if (!label.textRendererProperties.textFormat) {
		...
		protected function panelInitializer(panel:Panel):void
		{
			...
			panel.paddingTop = panel.paddingRight = panel.paddingBottom = panel.paddingLeft = 14 * this.scale;
		}
		...
		protected function messageInitializer(message:Message):void
		{
			message.minWidth = 88 * this.scale;
			message.minHeight = 88 * this.scale;
			message.maxWidth = this.root.stage.stageWidth * 0.9;
			message.maxContentWidth = (this.root.stage.stageWidth*0.9)-(26*this.scale);
			message.paddingTop = message.paddingBottom = 18 * this.scale;
			message.paddingLeft = message.paddingRight = 14 * this.scale;
			message.contentPadding = 12 * this.scale;
			
			message.textRendererProperties = {wordWrap:true, textFormat:this.centeredPrimaryTextFormat};
			
			const backgroundSkin:Scale9Image = new Scale9Image(popUpBackgroundSkinTextures, this.scale);
			backgroundSkin.width = 88 * this.scale;
			backgroundSkin.height = 88 * this.scale;
			message.backgroundSkin = backgroundSkin;
		}
		
		protected function alertInitializer(alert:Alert):void
		{
			alert.minWidth = 88 * this.scale;
			alert.minHeight = 88 * this.scale;
			alert.maxWidth = this.root.stage.stageWidth * 0.9;
			alert.maxContentWidth = (this.root.stage.stageWidth*0.9)-(26*this.scale);
			alert.paddingTop = alert.paddingBottom = 18 * this.scale;
			alert.paddingLeft = alert.paddingRight = 14 * this.scale;
			alert.contentPadding = 12 * this.scale;
			alert.gap = 24 * this.scale;
			
			alert.textRendererProperties = {wordWrap:true, textFormat:this.centeredPrimaryTextFormat};
		...
		protected function confirmInitializer(confirm:Confirm):void
		{
			confirm.minWidth = 88 * this.scale;
			confirm.minHeight = 88 * this.scale;
			confirm.maxWidth = this.root.stage.stageWidth * 0.9;
			confirm.maxContentWidth = (this.root.stage.stageWidth*0.9)-(52*this.scale);
			confirm.paddingTop = confirm.paddingBottom = 18 * this.scale;
			confirm.paddingLeft = confirm.paddingRight = 14 * this.scale;
			confirm.contentPadding = 12 * this.scale;
			confirm.verticalGap = 24 * this.scale;
			confirm.horizontalGap = 24 * this.scale;
			
			confirm.textRendererProperties = {wordWrap:true, textFormat:this.centeredPrimaryTextFormat};
			
			const backgroundSkin:Scale9Image = new Scale9Image(popUpBackgroundSkinTextures, this.scale);
			backgroundSkin.width = 88 * this.scale;
			backgroundSkin.height = 88 * this.scale;
			confirm.backgroundSkin = backgroundSkin;
		}
	}
}
